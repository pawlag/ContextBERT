...
class MultifileDataset(Dataset):
    def __init__(self, corpus_path, vocab, max_seq_len, max_tokens_len, min_seq_len, max_word_len, corpus_lines =0, context=False, context_vocab=None):
        self.vocab      = vocab        
    ...
    def __getitem__(self, idx):
        ...
        context, subl =  next(self.line_generator)
