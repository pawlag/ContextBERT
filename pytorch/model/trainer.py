...
class BERTTrainer:
    ...
    def __init__(self, 
        ...
        :param contex_size: total context features size (number of unique classes)
        ...
        # This BERT or ContextBERT model will be saved every epoch
        self.bert = bert

        # Initialize the BERT Language Model, with BERT o ContextBERT model
