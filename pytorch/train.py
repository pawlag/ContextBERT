...
from model.pretrain import BERTTrainer
...
def train():
    ...
    parser.add_argument("-cp", "--context_path", type=str, help="built context_dict model path with bert-vocab")
    ...
    if args.context:
        ...
        context_dict = WordVocab.load_vocab(args.context_path)
    ...
    train_dataset = BERTDataset(args.train_dataset, vocab, seq_len=args.seq_len, context=args.context, context_dict=context_dict, corpus_lines=args.corpus_lines, on_memory=args.on_memory)
